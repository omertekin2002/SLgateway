...
import { searchWeb as search } from "../src/pipeline/gemini-search";
...
function searchWeb(query: string, options?: { signal?: AbortSignal }) {
  return search(query, { ...options, apiKey: process.env.GEMINI_API_KEY });
}
