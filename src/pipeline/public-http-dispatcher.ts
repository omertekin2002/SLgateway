// Ported from SignLoop apps/web/lib/public-http-dispatcher.ts at 3f830abaae4d47dedecabea3fca57a4899a8f688.
...
export const lookupPublicAddress: LookupFunction = (
  hostname,
  options,
  callback,
) => {
  lookup(hostname, { ...options, all: true }, (error, addresses) => {
    ...
    if (
      ...
      callback(
        new Error(
          "The host did not resolve exclusively to public IP addresses.",
        ),
        [],
      );
      return;
